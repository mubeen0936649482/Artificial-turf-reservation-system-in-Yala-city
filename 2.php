...
if (isset($_GET['delete_id'])) {
    ...
    $sql_delete = "DELETE FROM malayubankok WHERE id='$delete_id'";
...
if (isset($_POST['update'])) {
    ...
    $sql_update = "UPDATE malayubankok SET fullname='$fullname', phone='$phone', field='$field', total_price='$total_price' WHERE id='$edit_id'";
...
<body>
    <div class="container">
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . ($status == 'confirmed' ? "<span style='color:green; font-weight:bold;'>Confirmed</span>" : "<a href='confirm_booking1.php?confirm_id=" . $row["id"] . "' class='btn btn-small'>Confirm</a>") . "</td>";
        ...
        if (isset($_GET['edit_id'])) {
            ...
            $sql_edit = "SELECT * FROM malayubankok WHERE id='$edit_id'";
            ...
            if ($result_edit->num_rows > 0) {
                ...
                echo "<form method='POST' action=''>
                    ...
                    <input type='text' name='fullname' value='" . $row_edit['fullname'] . "' required><br>
                    <label>Phone:</label>
                    <input type='text' name='phone' value='" . $row_edit['phone'] . "' required><br>
                    <label>Field:</label>
                    <input type='text' name='field' value='" . $row_edit['field'] . "' required><br>
                    <label>Total Price:</label>
                    <input type='number' name='total_price' value='" . $row_edit['total_price'] . "' required><br>
